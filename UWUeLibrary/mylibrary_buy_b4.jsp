      ...
      <div id="content">
       ...
       <table bg bgcolor="#D8D8D8"><td height="1px"><font size="1">YOUR ARE HERE : <a href="index.jsp">HOME </a> >> <a href="login.jsp">E-MEMBER LOGIN </a>  >> <a href="mylibrary.jsp">MY LIBRARY </a> >> <strong>BOOK IN DETAILED</strong></td></table>
        ...
        <hr class="line-break">
          ...
          <tr><td> <img src="images/books/b4.jpg" width="200"> </td> <td><font size="3" color="#000000"><strong> Name : </strong>Free at Last in Paradise <br>
                <strong>Language :</strong> English<br>
                <strong>Author : </strong>Ananda W. Guruge <br>
            <strong>Publisher :</strong> M.D Gunasena<br>
            <strong>Price :</strong> <font color="blue">670LKR</font><br>
            <strong>Book ID :</strong> <font color="red">ENG0244<br><br>
