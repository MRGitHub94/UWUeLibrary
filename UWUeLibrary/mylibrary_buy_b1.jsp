      ...
      <div id="content">
       ...
       <table bg bgcolor="#D8D8D8"><td height="1px"><font size="1">YOUR ARE HERE : <a href="index.jsp">HOME </a> >> <a href="login.jsp">E-MEMBER LOGIN </a>  >> <a href="mylibrary.jsp">MY LIBRARY </a> >> <strong>BOOK IN DETAILED</strong></td></table>
        ...
        <hr class="line-break">
          ...
          <tr><td> <img src="images/books/b1.jpg" width="200"> </td> <td><font size="3" color="#000000"><strong> Name : </strong>Pain of Evolution &amp; Other Science Fictions<br>
                <strong>Language :</strong> Sinhala<br>
                <strong>Author : </strong>Pathum Asanka Herath <br>
            <strong>Publisher :</strong> M.D Gunasena<br>
            <strong>Price :</strong> <font color="blue">850LKR</font><br>
            <strong>Book ID :</strong> <font color="red">SIN0587<br><br>
            <center><a href="order.jsp"><img src="images/buy.png"></a></font></center></td> </tr>
          </table>
