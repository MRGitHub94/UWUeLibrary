      ...
      <div id="content">
       ...
       <table bg bgcolor="#D8D8D8"><td height="1px"><font size="1">YOUR ARE HERE : <a href="index.jsp">HOME </a> >> <a href="login.jsp">E-MEMBER LOGIN </a>  >> <a href="mylibrary.jsp">MY LIBRARY </a> >> <strong>BOOK IN DETAILED</strong></td></table>
        ...
        <hr class="line-break">
          ...
          <tr><td> <img src="images/books/b6.jpg" width="200"> </td> <td><font size="3" color="#000000"><strong> Name : </strong>International Communication<br>
                <strong>Language :</strong> Sinhala<br>
                <strong>Author : </strong>Manoj Pushpakumara <br>
            <strong>Publisher :</strong> Godage International<br>
            <strong>Price :</strong> <font color="blue">900LKR</font><br>
            <strong>Book ID :</strong> <font color="red">SIN0488<br><br>
