  ...
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div id="content">
       ...
       <table bg bgcolor="#D8D8D8"><td height="1px"><font size="1">YOUR ARE HERE : <a href="index.jsp">HOME </a> >> <a href="login.jsp">E-MEMBER LOGIN </a>  >> <a href="mylibrary.jsp">MY LIBRARY </a> >> <strong>BOOK IN DETAILED</strong></td></table>
      
      
      
        <h1><font color="#F2951F">Book in Detailed..</font></h1>
        <p> Here you can see a short description of your choosen book.</p>
        <hr class="line-break">
          
          
          <table bgcolor="#E3B960">
          <tr><td> <img src="images/books/b5.jpg" width="200"> </td> <td><font size="3" color="#000000"><strong> Name : </strong>Manokaya, Maranaya Ha Sasara Pragamanaya<br>
                <strong>Language :</strong> Sinhala<br>
                <strong>Author : </strong>Dr. Sanathdewa Muruthange <br>
            <strong>Publisher :</strong> M.D Gunasena<br>
            <strong>Price :</strong> <font color="blue">850LKR</font><br>
            <strong>Book ID :</strong> <font color="red">SIN0425<br><br>
            <center><a href="order.jsp"><img src="images/borrow.png"></a></font></center></td> </tr>
          </table>
