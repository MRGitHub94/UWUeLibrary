...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <!--/ Side bar-->
      <div id="content">
      <table bg bgcolor="#D8D8D8"><td height="1px"><font size="1">YOUR ARE HERE : <a href="index.jsp">HOME </a> >> <a href="login.jsp">E-MEMBER LOGIN </a>  >> <a href="mylibrary.jsp">MY LIBRARY </a> >> <strong>BUYING BOOKS</strong></td></table>
      
        <h1><font color="#F2951F">Buying Books</font></h1>
        <p>You can see thousands of books to buy here. </p>
        
          <hr class="line-break">
          
         <center><img src="images/oops.png"></center>
         <center>
           <h1><strong><font color="red"> WE ARE UPDATING BUYING BOOKS. <br>PLEASE CHECK BACK LATER!</font></strong></h1>
         </center>
         
          <center>
           <em><strong><a href="mylibrary.jsp"> << Go back to previous page... </a></strong></em>
         </center>
